...
BODY_FONT_NAME = "Consolas" -- FixedSys/Consolas
BODY_FONT_SIZE = 12
SCROLL_BAR_WIDTH = 15
...
theme = {
    ...
    TITLE_FONT_NAME = BODY_FONT_NAME, -- for miniwindow title area
    TITLE_FONT_SIZE = 12 -- for miniwindow title area
}  -- end theme table
...
function drawStuff()
    ...
    -- Title text
    WindowText(Win, "titlefont"..Win, CHAT_WINDOW_NAME, ((WINDOW_WIDTH)-(7.5*line_height))/2, (theme.TITLE_HEIGHT-line_height)/2, WINDOW_WIDTH, theme.TITLE_HEIGHT, theme.DETAIL, false)
